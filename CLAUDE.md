...
```bash
dotnet run --project src/BgStacks.AppHost      # starts Cosmos emulator + Azurite containers automatically
...
- When using `src/BgStacks.AppHost`: no prerequisites — Aspire starts Cosmos emulator and Azurite containers automatically
